      ...
      children: [
        ...
        SBBHeaderbox(
          ...
          trailingWidget: SBBTertiaryButtonSmall(
            ...
            onPressed: () => sbbToast.show(title: 'Default pressed', bottom: SBBSpacing.medium * 6),
          ),
        ),
        const SizedBox(height: SBBSpacing.medium),
        ...
        SBBHeaderbox.large(
          ...
          trailingWidget: SBBTertiaryButton(
            iconData: SBBIcons.dog_small,
            onPressed: () => sbbToast.show(title: 'Large pressed', bottom: SBBSpacing.medium * 6),
          ),
        ),
        const SizedBox(height: SBBSpacing.medium),
      ...
      slivers: [
        ...
        SliverList.builder(
          ...
          itemBuilder: (context, index) => SBBListItem(
            ...
            onTap: () => sbbToast.show(title: 'Pressed Item $index', bottom: SBBSpacing.medium * 6),
          ),
        ),
      ],
    );
