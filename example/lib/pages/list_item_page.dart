          ...
          child: Column(
            children: <Widget>[
              ...
              SBBListItem(
                ...
                onPressed: () => sbbToast.show(message: 'ListItem with Call to Action'),
              ),
              SBBListItem(
                title: 'Subtitle',
              ...
              SBBListItem(
                ...
                trailingIcon: SBBIcons.chevron_small_right_small,
                onCallToAction: () => sbbToast.show(message: 'Call to Action'),
                onPressed: () => sbbToast.show(message: 'ListItem with Subtitle and Call to Action'),
              ),
              SBBListItem(
                ...
                trailingIcon: SBBIcons.chevron_small_right_small,
                onCallToAction: () => sbbToast.show(message: 'Call to Action'),
                onPressed: () => sbbToast.show(message: 'ListItem with Icon and Call to Action'),
              ),
              SBBListItem(
                title: 'Icon, Subtitle',
                leadingIcon: SBBIcons.clock_small,
              ...
              SBBListItem(
                ...
                trailingIcon: SBBIcons.chevron_small_right_small,
                onCallToAction: () => sbbToast.show(message: 'Call to Action'),
                onPressed: () => sbbToast.show(message: 'ListItem with Icon, Subtitle and Call to Action'),
              ),
            ],
          ),
        ),
