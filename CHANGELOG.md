...
- `SBBIconButtonSmall`: Use `SBBIconButton.small` instead
- `SBBIconButtonSmallNegative`: Use `SBBIconButton.smallNegative` instead
- `SBBIconButtonSmallBorderless`: Use `SBBIconButton.smallBorderless` instead
- `SBBIconButtonLarge`: Use `SBBIconButton.large` instead
