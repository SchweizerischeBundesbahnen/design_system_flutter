...
class SBBButtonStyle {
  ...
  SBBButtonStyle copyWith({
    ...
    backgroundColorLoading:
        backgroundColorLoading ?? this.backgroundColorLoading,
    borderColor: borderColor ?? this.borderColor,
    borderColorHighlighted:
        borderColorHighlighted ?? this.borderColorHighlighted,
  ...
  SBBButtonStyle lerp(SBBButtonStyle? other, double t) => SBBButtonStyle(
    ...
    backgroundColorLoading: Color.lerp(
      backgroundColorLoading,
      other?.backgroundColorLoading,
      t,
    ),
    borderColor: Color.lerp(borderColor, other?.borderColor, t),
    borderColorHighlighted: Color.lerp(
      borderColorHighlighted,
      other?.borderColorHighlighted,
      t,
    ),
    borderColorDisabled: Color.lerp(
      borderColorDisabled,
      other?.borderColorDisabled,
      t,
    ),
    borderColorLoading: Color.lerp(
      borderColorLoading,
      other?.borderColorLoading,
      t,
    ),
    textStyle: TextStyle.lerp(textStyle, other?.textStyle, t),
    textStyleHighlighted: TextStyle.lerp(
      textStyleHighlighted,
      other?.textStyleHighlighted,
      t,
    ),
    ...
    textStyleLoading: TextStyle.lerp(
      textStyleLoading,
      other?.textStyleLoading,
      t,
    ),
    iconColor: Color.lerp(iconColor, other?.iconColor, t),
    iconColorHighlighted: Color.lerp(
      iconColorHighlighted,
      other?.iconColorHighlighted,
      t,
    ),
            ...
            : SBBTheme.resolveStatesWith(
              ...
              disabledValue:
                  borderColorDisabled == null
                      ? null
                      : BorderSide(color: borderColorDisabled!),
            ),
    iconColor:
        iconColor != null
            ? SBBTheme.resolveStatesWith(
...
extension ButtonStyleExtension on SBBButtonStyle? {
  SBBButtonStyle merge(SBBButtonStyle? other) {
    ...
    return this!.copyWith(
      ...
      backgroundColorLoading:
          this!.backgroundColorLoading ?? other?.backgroundColorLoading,
      borderColor: this!.borderColor ?? other?.borderColor,
      borderColorHighlighted:
          this!.borderColorHighlighted ?? other?.borderColorHighlighted,
      borderColorDisabled:
      ...
      textStyleHighlighted:
          this!.textStyleHighlighted ?? other?.textStyleHighlighted,
      ...
      iconColorHighlighted:
          this!.iconColorHighlighted ?? other?.iconColorHighlighted,
