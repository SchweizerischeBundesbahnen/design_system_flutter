...
class SBBChipStyle {
    ...
    return SBBChipStyle(
      ...
      badgeTextStyle: SBBTextStyle(
        textStyle: baseStyle.themedTextStyle(
          textStyle: SBBTextStyles.smallBold,
      ...
      labelTextStyle: SBBTextStyle(
        textStyle: baseStyle.themedTextStyle(
          ...
          color: isDarkTheme ? SBBColors.white : SBBColors.black,
        ),
        textStyleDisabled: baseStyle.themedTextStyle(
          textStyle: SBBTextStyles.mediumLight,
          color: isDarkTheme ? SBBColors.graphite : SBBColors.granite,
        ),
      ),
      unselectButtonColor: isDarkTheme ? SBBColors.iron : SBBColors.milk,
      disabledUnselectButtonColor:
          isDarkTheme ? SBBColors.iron : SBBColors.milk,
      unselectButtonIconColor: isDarkTheme ? SBBColors.white : SBBColors.black,
      disabledUnselectButtonIconColor:
          isDarkTheme ? SBBColors.graphite : SBBColors.granite,
    );
  }
  ...
  SBBChipStyle copyWith({
    ...
    disabledUnselectButtonColor:
        disabledUnselectButtonColor ?? this.disabledUnselectButtonColor,
    unselectButtonIconColor:
        unselectButtonIconColor ?? this.unselectButtonIconColor,
    disabledUnselectButtonIconColor:
        disabledUnselectButtonIconColor ?? this.disabledUnselectButtonIconColor,
  );
  ...
  SBBChipStyle lerp(SBBChipStyle? other, double t) => SBBChipStyle(
    ...
    disabledBadgeColor: Color.lerp(
      disabledBadgeColor,
      other?.disabledBadgeColor,
      t,
    ),
    badgeTextStyle: badgeTextStyle?.lerp(other?.badgeTextStyle, t),
    labelTextStyle: labelTextStyle?.lerp(other?.labelTextStyle, t),
    unselectButtonColor: Color.lerp(
      unselectButtonColor,
      other?.unselectButtonColor,
      t,
    ),
    disabledUnselectButtonColor: Color.lerp(
      disabledUnselectButtonColor,
      other?.disabledUnselectButtonColor,
      t,
    ),
    unselectButtonIconColor: Color.lerp(
      unselectButtonIconColor,
      other?.unselectButtonIconColor,
      t,
    ),
    disabledUnselectButtonIconColor: Color.lerp(
      disabledUnselectButtonIconColor,
      other?.disabledUnselectButtonIconColor,
      t,
    ),
  );
}
...
extension SBBChipStyleExtension on SBBChipStyle? {
  SBBChipStyle merge(SBBChipStyle? other) {
    ...
    return this!.copyWith(
      ...
      disabledBorderColor:
          this!.disabledBorderColor ?? other?.disabledBorderColor,
      ...
      unselectButtonColor:
          this!.unselectButtonColor ?? other?.unselectButtonColor,
      disabledUnselectButtonColor:
          this!.disabledUnselectButtonColor ??
          other?.disabledUnselectButtonColor,
      unselectButtonIconColor:
          this!.unselectButtonIconColor ?? other?.unselectButtonIconColor,
      disabledUnselectButtonIconColor:
          this!.disabledUnselectButtonIconColor ??
          other?.disabledUnselectButtonIconColor,
    );
