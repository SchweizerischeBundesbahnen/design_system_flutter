...
class SBBBaseStyle extends ThemeExtension<SBBBaseStyle> {
  ...
  factory SBBBaseStyle.$default({
    ...
    return SBBBaseStyle(
      ...
      primarySwatch: MaterialColor(SBBColors.red.value, const <int, Color>{
        50: SBBColors.red,
        100: SBBColors.red,
        200: SBBColors.red,
        300: SBBColors.red,
  ...
  ThemeExtension<SBBBaseStyle> lerp(
    ThemeExtension<SBBBaseStyle>? other,
    double t,
  ) {
  ...
  TextTheme createTextTheme({Color? colorOverride}) {
    value(double size, double height, {Color? color, String? fontFamily}) =>
        TextStyle(
          inherit: false,
          fontSize: size,
          height: height,
