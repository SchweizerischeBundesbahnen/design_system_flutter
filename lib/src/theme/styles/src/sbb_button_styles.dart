...
class SBBButtonStyles extends ThemeExtension<SBBButtonStyles> {
  ...
  factory SBBButtonStyles.$default({required SBBBaseStyle baseStyle}) => SBBButtonStyles(
        primaryStyle: SBBButtonStyle(
          ...
          backgroundColorDisabled: baseStyle.themeValue(SBBColors.cement, SBBColors.iron),
          backgroundColorLoading: baseStyle.themeValue(SBBColors.cement, SBBColors.iron),
          textStyle: baseStyle.themedTextStyle(color: SBBColors.white),
          textStyleHighlighted: baseStyle.themedTextStyle(color: SBBColors.white),
        ...
        primaryNegativeStyle: SBBButtonStyle(
          ...
          backgroundColorHighlighted:
              baseStyle.themeValue(SBBColors.black.withOpacity(0.2), SBBColors.white.withOpacity(0.2)),
        ...
        secondaryStyle: SBBButtonStyle(
          ...
          backgroundColorHighlighted: baseStyle.themeValue(SBBColors.graphite, SBBColors.charcoal),
          backgroundColorDisabled: SBBColors.transparent,
          backgroundColorLoading: SBBColors.transparent,
          borderColor: baseStyle.themeValue(baseStyle.primaryColor, SBBColors.smoke),
          borderColorHighlighted: baseStyle.themeValue(baseStyle.primaryColor, SBBColors.smoke),
          borderColorDisabled: baseStyle.themeValue(SBBColors.graphite, SBBColors.smoke),
          borderColorLoading: baseStyle.themeValue(SBBColors.graphite, SBBColors.smoke),
          textStyle: baseStyle.themedTextStyle(color: baseStyle.themeValue(baseStyle.primaryColor, SBBColors.white)),
          textStyleHighlighted:
              baseStyle.themedTextStyle(color: baseStyle.themeValue(baseStyle.primaryColorDark, SBBColors.white)),
          textStyleDisabled:
              baseStyle.themedTextStyle(color: baseStyle.themeValue(SBBColors.graphite, SBBColors.smoke)),
          textStyleLoading: baseStyle.themedTextStyle(color: baseStyle.themeValue(SBBColors.graphite, SBBColors.smoke)),
        ),
        tertiarySmallStyle: SBBButtonStyle(
          backgroundColor: baseStyle.themeValue(SBBColors.white, SBBColors.charcoal),
          backgroundColorHighlighted: baseStyle.themeValue(SBBColors.graphite, SBBColors.black),
          backgroundColorDisabled: SBBColors.transparent,
          ...
          textStyle: baseStyle.themedTextStyle(textStyle: SBBTextStyles.mediumLight),
          textStyleHighlighted: baseStyle.themedTextStyle(textStyle: SBBTextStyles.mediumLight),
        ...
        iconSmallBorderlessStyle: SBBButtonStyle(
          ...
          backgroundColorDisabled: SBBColors.transparent,
          iconColor: baseStyle.iconColor,
          iconColorHighlighted: baseStyle.themeValue(SBBColors.metal, SBBColors.aluminum),
        ...
        iconTextStyle: SBBButtonStyle(
          backgroundColor: baseStyle.themeValue(SBBColors.white, SBBColors.charcoal),
          backgroundColorHighlighted: baseStyle.themeValue(SBBColors.milk, SBBColors.iron),
          backgroundColorDisabled: baseStyle.themeValue(SBBColors.white, SBBColors.charcoal),
          textStyle: baseStyle.themedTextStyle(textStyle: SBBTextStyles.smallLight),
          textStyleHighlighted: baseStyle.themedTextStyle(textStyle: SBBTextStyles.smallLight),
          textStyleDisabled: baseStyle.themedTextStyle(textStyle: SBBTextStyles.smallLight, color: SBBColors.metal),
  ...
  static ButtonLabelBuilder defaultButtonLabelBuilder = (_, String label) => SBBButtonContent(label: label);
  ...
  ButtonStyle get baseButtonStyle => ButtonStyle(
        ...
        shape: SBBTheme.allStates(
          RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(SBBInternal.defaultButtonHeight / 2),
          ),
        ),
        fixedSize: SBBTheme.allStates(const Size.fromHeight(SBBInternal.defaultButtonHeight)),
        padding: SBBTheme.allStates(const EdgeInsets.symmetric(horizontal: sbbDefaultSpacing)),
  ...
  @override
  ThemeExtension<SBBButtonStyles> lerp(ThemeExtension<SBBButtonStyles>? other, double t) {
    if (other is! SBBButtonStyles) return this;
    return SBBButtonStyles(
      primaryStyle: primaryStyle?.lerp(other.primaryStyle, t),
      primaryNegativeStyle: primaryNegativeStyle?.lerp(other.primaryNegativeStyle, t),
