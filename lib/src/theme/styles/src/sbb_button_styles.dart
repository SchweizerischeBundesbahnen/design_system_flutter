...
class SBBButtonStyles extends ThemeExtension<SBBButtonStyles> {
  ...
  factory SBBButtonStyles.$default({
    ...
    primaryStyle: SBBButtonStyle(
      ...
      backgroundColorLoading: baseStyle.themeValue(
        SBBColors.cement,
        SBBColors.iron,
      ),
    ...
    secondaryStyle: SBBButtonStyle(
      ...
      borderColorHighlighted: baseStyle.themeValue(
        baseStyle.primaryColor,
        SBBColors.smoke,
      ),
      ...
      borderColorLoading: baseStyle.themeValue(
        SBBColors.graphite,
        SBBColors.smoke,
      ),
    ...
    iconSmallBorderlessStyle: SBBButtonStyle(
      ...
      backgroundColorDisabled: SBBColors.transparent,
      iconColor: baseStyle.iconColor,
      iconColorHighlighted: baseStyle.themeValue(
        SBBColors.metal,
        SBBColors.aluminum,
      ),
  ...
  ThemeExtension<SBBButtonStyles> lerp(
    ...
    return SBBButtonStyles(
      ...
      iconLargeNegativeStyle: iconLargeNegativeStyle?.lerp(
        other.iconLargeNegativeStyle,
        t,
      ),
      iconSmallStyle: iconSmallStyle?.lerp(other.iconSmallStyle, t),
      iconSmallNegativeStyle: iconSmallNegativeStyle?.lerp(
        other.iconSmallNegativeStyle,
        t,
      ),
      iconSmallBorderlessStyle: iconSmallBorderlessStyle?.lerp(
...
extension ButtonStylesExtension on SBBButtonStyles? {
  SBBButtonStyles merge(SBBButtonStyles? other) {
    ...
    return this!.copyWith(
          ...
          primaryNegativeStyle: this!.primaryNegativeStyle.merge(
            other?.primaryNegativeStyle,
          ),
          secondaryStyle: this!.secondaryStyle.merge(other?.secondaryStyle),
          tertiarySmallStyle: this!.tertiarySmallStyle.merge(
            other?.tertiarySmallStyle,
          ),
          tertiaryLargeStyle: this!.tertiaryLargeStyle.merge(
            other?.tertiaryLargeStyle,
          ),
          iconLargeStyle: this!.iconLargeStyle.merge(other?.iconLargeStyle),
          iconLargeNegativeStyle: this!.iconLargeNegativeStyle.merge(
            other?.iconLargeNegativeStyle,
          ),
          iconSmallStyle: this!.iconSmallStyle.merge(other?.iconSmallStyle),
          iconSmallNegativeStyle: this!.iconSmallNegativeStyle.merge(
            other?.iconSmallNegativeStyle,
          ),
          ...
          buttonLabelBuilder:
              this!.buttonLabelBuilder ?? other?.buttonLabelBuilder,
        )
        as SBBButtonStyles;
  }
}
