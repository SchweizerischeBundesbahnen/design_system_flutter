  ...
  factory SBBButtonStyles.$default({required SBBBaseStyle baseStyle}) => SBBButtonStyles(
    ...
    secondaryStyle: SBBButtonStyle(
      ...
      textStyle: baseStyle.themedTextStyle(
        color: baseStyle.themeValue(baseStyle.primaryColor, SBBColors.white),
      ),
      ...
      textStyleLoading: baseStyle.themedTextStyle(
        color: baseStyle.themeValue(SBBColors.graphite, SBBColors.smoke),
      ),
    ),
...
extension ButtonStylesExtension on SBBButtonStyles? {
  SBBButtonStyles merge(SBBButtonStyles? other) {
    ...
    return this!.copyWith(
          ...
          iconSmallBorderlessStyle: this!.iconSmallBorderlessStyle.merge(
            other?.iconSmallBorderlessStyle,
          ),
