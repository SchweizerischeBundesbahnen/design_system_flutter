  ...
  factory SBBButtonStyles.$default({required SBBBaseStyle baseStyle}) => SBBButtonStyles(
    ...
    primaryNegativeStyle: SBBButtonStyle(
      ...
      backgroundColorHighlighted: baseStyle.themeValue(
        SBBColors.black.withValues(alpha: 0.2),
        SBBColors.white.withValues(alpha: 0.2),
      ),
      ...
      borderColorDisabled: SBBColors.white.withValues(alpha: 0.5),
      borderColorLoading: SBBColors.white.withValues(alpha: 0.5),
      textStyle: baseStyle.themedTextStyle(color: SBBColors.white),
      textStyleHighlighted: baseStyle.themedTextStyle(color: SBBColors.white),
      textStyleDisabled: baseStyle.themedTextStyle(color: SBBColors.white),
      textStyleLoading: baseStyle.themedTextStyle(color: SBBColors.white),
    ...
    iconLargeNegativeStyle: SBBButtonStyle(
      ...
      iconColorDisabled: SBBColors.white.withValues(alpha: 0.5),
    ),
