...
class SBBButtonStyles extends ThemeExtension<SBBButtonStyles> {
  ...
  ButtonStyle get baseButtonStyle => ButtonStyle(
    ...
    shape: SBBTheme.allStates(
      RoundedRectangleBorder(borderRadius: BorderRadius.circular(SBBInternal.defaultButtonHeight / 2)),
    ),
  ...
  FilledButtonThemeData get filledButtonTheme =>
      FilledButtonThemeData(style: primaryStyle?.overrideButtonStyle(baseButtonStyle));

  OutlinedButtonThemeData get outlinedButtonTheme =>
      OutlinedButtonThemeData(style: secondaryStyle?.overrideButtonStyle(baseButtonStyle));

  TextButtonThemeData get textButtonTheme =>
      TextButtonThemeData(style: tertiaryLargeStyle?.overrideButtonStyle(baseButtonStyle));
