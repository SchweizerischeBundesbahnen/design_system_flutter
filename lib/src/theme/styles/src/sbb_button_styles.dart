...
class SBBButtonStyles extends ThemeExtension<SBBButtonStyles> {
  ...
  factory SBBButtonStyles.$default({required SBBBaseStyle baseStyle}) => SBBButtonStyles(
        ...
        secondaryStyle: SBBButtonStyle(
          ...
          backgroundColorHighlighted: baseStyle.themeValue(SBBColors.milk, SBBColors.smoke),
          backgroundColorDisabled: SBBColors.transparent,
          backgroundColorLoading: SBBColors.transparent,
          borderColor: baseStyle.themeValue(baseStyle.primaryColor, SBBColors.white),
          borderColorHighlighted: baseStyle.themeValue(baseStyle.primaryColorDark, SBBColors.white),
          borderColorDisabled: baseStyle.themeValue(SBBColors.cement, SBBColors.iron),
          borderColorLoading: baseStyle.themeValue(SBBColors.cement, SBBColors.iron),
          textStyle: baseStyle.themedTextStyle(color: baseStyle.themeValue(baseStyle.primaryColor, SBBColors.white)),
          textStyleHighlighted: baseStyle.themedTextStyle(color: baseStyle.themeValue(baseStyle.primaryColorDark, SBBColors.white)),
        ...
        tertiarySmallStyle: SBBButtonStyle(
          ...
          backgroundColorDisabled: baseStyle.themeValue(SBBColors.transparent, SBBColors.transparent),
