...
class SBBLoadingIndicator extends StatelessWidget {
  ...
  const SBBLoadingIndicator.mediumCloud({Key? key})
    : this.medium(key: key, color: SBBColors.cloud);
