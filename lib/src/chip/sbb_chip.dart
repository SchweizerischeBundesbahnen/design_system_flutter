...
class SBBChip extends StatelessWidget {
  ...
  Padding _label(SBBChipStyle style) {
    final labelTextStyle =
        _disabled ? style.labelTextStyle!.textStyleDisabled : style.labelTextStyle!.textStyle;
    return Padding(
  ...
  Widget _badge(SBBChipStyle style) {
    final badgeTextStyle =
        _disabled ? style.badgeTextStyle!.textStyleDisabled : style.badgeTextStyle!.textStyle;
  ...
  Container _roundedContainer({
    ...
    return Container(
      margin: const EdgeInsets.all(_kChipMargin),
      padding: padding,
