...
class DefaultSBBPrimaryButtonStyle extends SBBButtonStyle2 {
  DefaultSBBPrimaryButtonStyle(SBBBaseStyle baseStyle)
    : super(
...
class DefaultSBBSecondaryButtonStyle extends SBBButtonStyle2 {
  DefaultSBBSecondaryButtonStyle(SBBBaseStyle baseStyle)
    : super(
        textStyle: WidgetStateProperty.fromMap(<WidgetStatesConstraint, TextStyle?>{
          WidgetState.any: baseStyle.themedTextStyle(),
        }),
        ...
        foregroundColor: WidgetStateProperty.fromMap(<WidgetStatesConstraint, Color?>{
          WidgetState.focused | WidgetState.pressed: baseStyle.themeValue(baseStyle.primaryColorDark, SBBColors.white),
...
class DefaultSBBTertiaryButtonStyle extends SBBButtonStyle2 {
  DefaultSBBTertiaryButtonStyle(SBBBaseStyle baseStyle)
    : super(
        textStyle: WidgetStateProperty.fromMap(<WidgetStatesConstraint, TextStyle?>{
          WidgetState.any: baseStyle.themedTextStyle(),
        }),
