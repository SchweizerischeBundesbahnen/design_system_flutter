...
class TestSpecs {
  ...
  factory TestSpecs.light() =>
      const TestSpecs._(size: _size, brightness: Brightness.light);

  factory TestSpecs.dark() =>
      const TestSpecs._(size: _size, brightness: Brightness.dark);
