...
void main() {
  void generateTest(String name, DateTime initialDateTime, DateTime? minimumDateTime, DateTime? maximumDateTime) {
    ...
    testWidgets(name, (WidgetTester tester) async {
      await TestSpecs.run(TestSpecs.themedSpecs, widget, tester, name, find.byType(DateTimePickerTest));
    });
  }
    ...
    children: <Widget>[
      Row(
        children: [
          ...
          Expanded(
            child: SBBGroup(
              child: SBBDateTimePicker(onDateTimeChanged: (_) {}, initialDateTime: initialDateTime, minuteInterval: 15),
            ),
          ),
        ],
      ),
