...
void main() {
  void generateTest(String name, int? v1, int? v2) {
    testWidgets(name, (WidgetTester tester) async {
      ...
      await TestSpecs.run(TestSpecs.themedSpecs, widget, tester, '${name}_initial', find.byType(RadioTest));
    });
  }
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      SBBGroup(
        child: Column(
          children: [
            SBBRadioListItem<int>(value: 1, groupValue: listItemGroupValue, onChanged: (newValue) {}, label: 'Label'),
